highPotentialWords = [
    ...
    "book", "boom", "boot", "born", "both", "bowl", "bulk", "burn", "bush", "busy",
    ...
    "text", "than", "thank", "that", "them", "then", "they", "thin", "this", "thus",
...
for i in range(len(highPotentialWords)):
    if (len(highPotentialWords[i]) == 4):
        new.append(highPotentialWords[i])
    else:
        print(highPotentialWords[i])

print(len(highPotentialWords), len(new))
